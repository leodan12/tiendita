            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h4 id="mititulo">INVENTARIO DE INSTRUMENTOS:
                                </h4>
                            </div>
                        </div>
                    </div>
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3   mb-3">
                                                <label for="vergarantia" class="col-form-label">GARANTIA:</label>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var tabla = "#mitabla";
            var ruta = "{{ route('inventarioinstrumento.index') }}"; //darle un nombre a la ruta index
            var columnas = [{
                    data: 'id',
                    name: 'id'
                },
            ...
            var nroeliminados = "{{ url('admin/instrumentos/numerosinstock') }}";
        ...
        mimodal.addEventListener('show.bs.modal', event => {
            ...
            $.get(urlregistro + '/' + id, function(data) {
                ...
                modalTitle.textContent = `Ver Inventario del instrumento ${id}`;
                console.log(accion);
        ...
        modalsinstock.addEventListener('show.bs.modal', event => {
            ...
            var urldatos = "{{ url('admin/instrumentos/showsinstock') }}";
            ...
            $.get(urldatos, function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    modalTitle.textContent =
                        `Tienes ${nrosinstock} Instrumentos sin stock y ${nrostockminimo} con stock minimo`;
        ...
        function mostrarmensajetitulo(numsinstock) {
            var registro = "INVENTARIO DE instrumentos: ";
            var tienes = "";
            var stock = " instrumentos en stock minimo";
            var boton =
