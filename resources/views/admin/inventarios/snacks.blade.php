            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h4 id="mititulo">INVENTARIO DE SNACKS:
                                </h4>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="modal-dialog modal-xl">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h1 class="modal-title fs-5" id="mimodalLabel">Ver Snack</h1>
                                ...
                                <div class="modal-body">
                                    <form>
                                        <div class="row">
                                            ...
                                            <div class="col-sm-3 mb-3">
                                                <label for="vertamanio" class="col-form-label">TAMAÑO:</label>
                                                <input type="text" class="form-control" id="vertamanio" readonly>
                                            </div>
                                            <div class="col-sm-3 mb-3">
                                                <label for="verfechavencimiento" class="col-form-label">FECHA
                                                    VENCIMIENTO:</label>
                                                <input type="text" class="form-control" id="verfechavencimiento"
                                                    readonly>
                                            </div>
                                            <hr>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var tabla = "#mitabla";
            var ruta = "{{ route('inventariosnacks.index') }}"; //darle un nombre a la ruta index
            var columnas = [{
                    data: 'id',
                    name: 'id'
                },
            ...
            var rutasinstock = "{{ url('admin/snacks/numerosinstock') }}";
        ...
        mimodal.addEventListener('show.bs.modal', event => {
            ...
            $.get(urlregistro + '/' + id, function(data) {
                ...
                modalTitle.textContent = `Ver Inventario de los Snacks ${id}`;
        ...
        function actualizarstock() {
            var urlstock = "{{ url('admin/snacks/updatestock') }}";
        ...
        modalsinstock.addEventListener('show.bs.modal', event => {
            ...
            var urldatos = "{{ url('admin/snacks/showsinstock') }}";
            ...
            $.get(urldatos, function(data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    modalTitle.textContent =
                        `Tienes ${nrosinstock} snacks sin stock y ${nrostockminimo} con stock minimo`;

                    filaDetalle = colorfondo +
                        '<td>' + data[i].id +
                        '</td><td>' + data[i].nombre +
                        '</td><td>' + data[i].marcasnack +
                        '</td><td>' + data[i].saborsnack +
                        '</td><td>' + data[i].tamanio +
                        '</td><td>' + data[i].fechavencimiento +
                        '</td><td>' + data[i].precio +
                        '</td><td>' + data[i].stock1 +
                        '</td><td>' + data[i].stock2 +
        ...
        function mostrarmensajetitulo(numsinstock) {
            var registro = "INVENTARIO DE SNACKS: ";
            var tienes = "";
            var stock = " Snacks en stock minimo";
            var boton =
