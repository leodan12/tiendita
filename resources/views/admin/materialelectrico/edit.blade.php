        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>EDITAR MATERIAL ELECTRICO
                        <a href="{{ url('admin/materialelectrico') }}" class="btn btn-primary text-white float-end">VOLVER</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/materialelectrico/' . $material->id) }}" method="POST"
                        ...
                        <div class="row">
                                ...
                                <select class="form-select select2 " name="carroceria_id" id="carroceria_id" required>
                                    ...
                                    @foreach ($carrocerias as $carroceria)
                                        <option value="{{ $carroceria->id }}"
                                            {{ $carroceria->id == $material->carroceria_id ? 'selected' : 'disabled' }}>
                                ...
                                <select class="form-select select2 " name="modelo_id" id="modelo_id" required>
                                    ...
                                    @foreach ($modelos as $modelo)
                                        <option value="{{ $modelo->id }}"
                                            {{ $modelo->id == $material->modelo_id ? 'selected' : 'disabled' }}>
                            ...
                            <h4>Agregar Detalle al Material Electrico</h4>
            ...
            if (lugardato == "db") {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var miurl = "{{ url('admin/materialelectrico/deletedetallematerial') }}";
