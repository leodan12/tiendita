        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4>AÑADIR MATERIAL ELECTRICO
                        <a href="{{ url('admin/materialelectrico') }}" class="btn btn-primary text-white float-end">VOLVER</a>
                    </h4>
                </div>
                <div class="card-body">
                    <form action="{{ url('admin/materialelectrico') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
    ...
    <script type="text/javascript">
        ...
        $("#carroceria_id").change(function() {
            $("#carroceria_id option:selected").each(function() {
                ...
                if (carroceria_id) {
                    var urlvent = "{{ url('admin/materialelectrico/modeloxcarroceria') }}";
