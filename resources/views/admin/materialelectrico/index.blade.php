            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="row">
                            <div class="col">
                                <h4 id="mititulo">MATERIAL ELECTRICO:
                                </h4>
                            </div>
                            <div class="col">
                                <h4>
                                    @can('crear-material-electrico')
                                        <a href="{{ url('admin/materialelectrico/create') }}" class="btn btn-primary float-end">Añadir
                            ...
                            <div class="modal-dialog modal-lg">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h1 class="modal-title fs-5" id="mimodalLabel">Ver Material Electrico</h1>
...
@push('script')
    ...
    <script>
        ...
        $(document).ready(function() {
            var tabla = "#mitabla";
            var ruta = "{{ route('materialelectrico.index') }}"; //darle un nombre a la ruta index
            var columnas = [{
                    data: 'id',
                    name: 'id'
                },
        ...
        $(document).on('click', '.btnborrar', function(event) {
            ...
            var urlregistro = "{{ url('admin/materialelectrico') }}";
            Swal.fire({
        ...
        mimodal.addEventListener('show.bs.modal', event => {
            ...
            var urlregistro = "{{ url('admin/materialelectrico/show') }}";
            $.get(urlregistro + '/' + id, function(data) {
                const modalTitle = mimodal.querySelector('.modal-title')
                modalTitle.textContent = `Ver Material Electrico ${id}`
                document.getElementById("vernombre").value = data[0].nombrematerial;
