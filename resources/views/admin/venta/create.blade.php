                    ...
                    <div class="row">
                        ...
                        <div class="col-md-2 mb-3">
                            <div class="input-group">
                                ...
                                <input type="number" name="costoventa" id="costoventa" min="0.1" step="0.01" class="form-control sinborde  required" required style="background-color: #fb0c3249" />
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4 mb-1">
                                ...
                                <input type="number" name="cantidad" id="cantidad" min="1" step="1" class="form-control " />
                            </div>
                            <div class="col-md-4 mb-1">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="preciounitariomo" min="0" step="0.0001" id="preciounitariomo" class="form-control " />
                                </div>
                            </div>
                            <div class="col-md-4 mb-3">
                                <div class="input-group">
                                    ...
                                    <input type="number" name="preciofinal" min="0" step="0.0001" id="preciofinal" class="form-control " />
                                </div>
                            </div>
                            <button type="button" class="btn btn-info" id="addDetalleBatch"><i class="fa fa-plus"></i>
                                Agregar Producto a la Venta</button>
                            <div class="table-responsive">
                                <table class="table table-striped table-striped table-row-bordered gy-5 gs-5" id="detallesVenta">
            ...
            for (var i = 0; i < data.length; i++) {
                ...
                if (tipoproducto == "UTILES") {
                    ...
                    valortexto = data[i].titulo + " - " + data[i].autor + " - " + data[i].anio +
                        ...
                        " - " + data[i].tipopasta + " - " + data[i].edicion + " - " + data[i].especializacion;
                ...
                producto_select += '<option id="productoxtipo' + data[i].id +
                    '" value="' + data[i].id + '" data-nombre="' + data[i].nombre + '" data-stock1="' +
